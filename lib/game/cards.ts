...
/** Movement-heavy deck, drawn on tiles 9 / 23 / 26. */
export const CHANCE: Card[] = [
  ...
  { id: "ch02", deck: "chance", text: "A clear run at 6am. Advance to Autobahn.", action: { type: "move", to: 5 } },
  { id: "ch03", deck: "chance", text: "You take the Neher-e-Khayyam shortcut. Advance there.", action: { type: "move", to: 18 } },
  ...
  { id: "ch08", deck: "chance", text: "Mango season. Advance to Nizamani Orchards.", action: { type: "move", to: 27 } },
  { id: "ch09", deck: "chance", text: "Sana finds parking in Zamzama on the first try. Advance to Zamzama.", action: { type: "move", to: 19 } },
  ...
  { id: "ch12", deck: "chance", text: "Sunset drive. Advance to Sea View.", action: { type: "move", to: 22 } },
...
/** Money-heavy deck, drawn on tiles 2 / 16. */
