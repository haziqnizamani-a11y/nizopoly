...
export const BOARD: Tile[] = [
  ...
  { index: 2, kind: "chest", name: "Family Business", short: "Family" },
  {
    index: 3,
    kind: "property",
    name: "Tando Soomro",
  ...
  { index: 7, kind: "chance", name: "Karachi Traffic", short: "Traffic" },
  {
    index: 8,
    kind: "property",
    name: "Das Numbri",
  ...
  { index: 17, kind: "chest", name: "Family Business", short: "Family" },
  {
    index: 18,
    kind: "property",
    name: "Triggy",
  ...
  { index: 22, kind: "chance", name: "Karachi Traffic", short: "Traffic" },
  {
    index: 23,
    kind: "property",
    name: "Mirchilli",
  ...
  { index: 33, kind: "chest", name: "Family Business", short: "Family" },
  {
    index: 34,
    kind: "property",
    name: "Boat Basin",
  ...
  { index: 36, kind: "chance", name: "Karachi Traffic", short: "Traffic" },
  {
    index: 37,
    kind: "property",
    name: "D.H.A Phase 8",
